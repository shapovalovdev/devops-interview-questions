...
- Fault injection is not uniformly portable: Gateway API leaves it to implementation-specific extensions, and Linkerd ships no injection knob at all — the time-boxed, narrowly matched experiment design is the part that travels.
