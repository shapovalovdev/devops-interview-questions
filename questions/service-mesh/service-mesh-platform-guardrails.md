...
- Safe defaults have mesh-specific shapes: Linkerd's mTLS-by-default plus Server/ServerAuthorization policy is the smaller version of the same paved path — measured adoption and exception expiry are the portable requirements, whichever CRDs express them.
