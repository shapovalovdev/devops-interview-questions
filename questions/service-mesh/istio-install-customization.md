...
- Installation-as-versioned-config is portable: Linkerd and Cilium are also Helm-installed with pinned values, and the same review-manifests-then-stage-enrollment loop applies — mutating live control-plane resources is the anti-pattern in each.
