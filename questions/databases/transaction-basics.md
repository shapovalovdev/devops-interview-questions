...
sources:
  ...
  - url: https://learn.microsoft.com/sql/t-sql/language-elements/begin-transaction-transact-sql
    source_type: official-docs
...
- The unit-of-work contract is engine-neutral SQL: SQL Server's BEGIN TRANSACTION...COMMIT/ROLLBACK and MySQL's START TRANSACTION implement the same grouping with the same crash semantics, so the boundary-selection reasoning transfers unchanged to another engine.
...
- [SQL Server — BEGIN TRANSACTION](https://learn.microsoft.com/sql/t-sql/language-elements/begin-transaction-transact-sql)
