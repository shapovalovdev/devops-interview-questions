...
The epic [Epic: deploy immutable snapshot service to k3s](https://github.com/shapovalovdev/devops-interview-questions/issues/205) and release [Snapshot service k3s v1](https://github.com/shapovalovdev/devops-interview-questions/milestone/13) closed 2026-08-20 with every issue verified.

The active epic, charted 2026-08-20, is [Epic: Authoritative Learning Paths, Career Tracks & Visual DAG Manifests](https://github.com/shapovalovdev/devops-interview-questions/issues/223), release **Learning paths and career tracks v1** (milestone 14). It establishes `devops_questions` as the single authoritative source of truth for structured curriculum learning paths, career tracks, and prerequisite DAG metadata. Track manifests define declarative competency nodes, prerequisite links, and certification mappings, which are ingested into SQLite `content.db`, served via the versioned FastAPI Content API (`/api/v1/learning-paths`), and distributed in immutable snapshot release tarballs.
