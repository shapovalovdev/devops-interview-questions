...
| 0002 | [API contract and tracer-bullet service](./0002-api-contract-and-service.md) | `closed` | — | `feature/api-contract` |
| 0003 | [Complete read surface over the real store](./0003-api-read-surface.md) | `ready-for-agent` | 0001, 0002 | `feature/api-read-surface` |
