...
| 0004 | [Write surface: CRUD, Write credential, optimistic concurrency](./0004-api-write-surface.md) | [#172](https://github.com/shapovalovdev/devops-interview-questions/issues/172) | `blocked` | 0003 | `feature/api-write-surface` |
| 0005 | [Export to Markdown and the CI Drift gate](./0005-export-and-drift-gate.md) | [#173](https://github.com/shapovalovdev/devops-interview-questions/issues/173) | `in-progress` | 0001 | `feature/content-export-drift` |
