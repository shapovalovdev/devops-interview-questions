...
| --- | --- | --- | --- | --- |
| 0001 | [Content store schema and Ingest](./0001-content-store-and-ingest.md) | `ready-for-agent` | — | `feature/content-store-ingest` |
| 0002 | [API contract and tracer-bullet service](./0002-api-contract-and-service.md) | `ready-for-agent` | — | `feature/api-contract` |
...
| 0005 | [Export to Markdown and the CI Drift gate](./0005-export-and-drift-gate.md) | `blocked` | 0001 | `feature/content-export-drift` |
