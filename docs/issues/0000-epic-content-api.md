...
Vocabulary is defined in root `CONTEXT.md`; the architectural decision and its trade-offs are recorded in [ADR 0001](../adr/0001-sqlite-content-store-behind-a-fastapi-content-api.md).
